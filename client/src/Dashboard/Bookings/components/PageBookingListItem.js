...
const PageBookingListItem = (props) => {
    ...
    useEffect(() => {
        axios
            .get(`http://https://stagelyt-mysql.herokuapp.com/api/bookings/${booking_id}`)
            .then((res) => {
    ...
    const acceptGig = (status) => {
        ...
        console.log(status)
        axios.put(`http://https://stagelyt-mysql.herokuapp.com/api/bookings/accept/${booking.id}`, { status: status })
            .then((res) => {
    ...
    useEffect(() => {
        axios
            .get(`http://https://stagelyt-mysql.herokuapp.com/api/events/${booking.event_id}`)
            .then((res) => {
